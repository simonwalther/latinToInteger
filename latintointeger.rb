    ...
    latin_number.length.times do |i|
      ...
      if latin_number != nil && LetterArray.include?(current_latin_number) == false
        ...
        if current_latin_number != LetterArray.last
          ...
          if (LetterArray.index(current_latin_number)+2)%2 == 0
            #if the previous letter index is bigger by two than the current letter index
            if (i-1) >= 0 && LetterArray.index(current_latin_number) == (LetterArray.index(previous_latin_number)-2)
              #if there's two times or more the previous letter
              if (i-2) >= 0 && LetterArray.index(previous_latin_number) == LetterArray.index(previous_latin_number_2)
                #it raise an error
                raise "#{previous_latin_number_2}#{previous_latin_number}#{current_latin_number} isn't a correct combination (#{previous_latin_number}#{current_latin_number} is)"
              else
                ...
                integer_number += (ValueArray[LetterArray.index(current_latin_number)]-(ValueArray[LetterArray.index(previous_latin_number)])*2)
              end
            #if there's 4 times or more the same letter and if the letter isn't M
            elsif (i-3) >= 0 && LetterArray.index(current_latin_number) != 0 && LetterArray.index(previous_latin_number_3) == LetterArray.index(previous_latin_number_2) && previous_latin_number_2 == previous_latin_number && previous_latin_number == current_latin_number
              #it raise an error
              raise "#{previous_latin_number_3}#{previous_latin_number_2}#{previous_latin_number}#{current_latin_number} isn't a correct combination (#{current_latin_number}#{LetterArray[(LetterArray.index(current_latin_number))-1]} is) #1"
            #if there's five or more times the letter M
            elsif (i-4) >= 0 && LetterArray.index(current_latin_number) == 0 && LetterArray.index(previous_latin_number_4) == LetterArray.index(previous_latin_number_3) && previous_latin_number_3 == previous_latin_number_2 && previous_latin_number_2 == previous_latin_number && previous_latin_number == current_latin_number
              #it raise an error
            ...
            elsif (i-1) >= 0 && ((LetterArray.index(current_latin_number)-LetterArray.index(previous_latin_number)) == -1 || (LetterArray.index(current_latin_number)-LetterArray.index(previous_latin_number)) <= -3)
              #it raise an error
            ...
            elsif (i-3) >= 0 && LetterArray.index(previous_latin_number) == LetterArray.index(previous_latin_number_2) && LetterArray.index(previous_latin_number) > LetterArray.index(current_latin_number)
          ...
          elsif (LetterArray.index(current_latin_number)+2)%2 == 1
            #if the previous letter index is bigger by 1 than the current letter
            if (i-1) >= 0 && LetterArray.index(current_latin_number) == (LetterArray.index(previous_latin_number)-1)
              #if there's two times or more the previous letter
              if (i-2) >= 0 && LetterArray.index(previous_latin_number) == LetterArray.index(previous_latin_number_2)
                #it raise an error
                raise "#{previous_latin_number_2}#{previous_latin_number}#{current_latin_number} isn't a correct combination (#{previous_latin_number}#{current_latin_number} is)"
            ...
            elsif (i-1) >= 0 && current_latin_number == previous_latin_number || (LetterArray.index(current_latin_number)-LetterArray.index(previous_latin_number)) <= -2
              #it raise an error
          ...
          if (i-3) >= 0 && previous_latin_number_3 == previous_latin_number_2 && previous_latin_number_2 == previous_latin_number && previous_latin_number = current_latin_number
            #it raise an error
            raise "#{previous_latin_number_3}#{previous_latin_number_2}#{previous_latin_number}#{current_latin_number} isn't a correct combination (#{current_latin_number}#{LetterArray[(LetterArray.index(current_latin_number))-1]} is) #2"
          else
